var Conch = {
    ...
    'Shows':{
        ...
        'Copyright':function(){
            var $nam = '海螺模版Conch_M003',
                $web = 'https://www.98dou.cn',
                $qqh = 'https://www.98dou.cn/3461.html',
                $qun = '觅知博客',
                $ver = conchtpl.ver;
            ...
            console.log("%c永久更新地址：%c "+$qqh+"  "+$qun+"", "color:#030307;font-size:14px;line-height:32px;", "color:#ff1500;font-size:14px");
        },
    },
    'Other':{
        'Init': function() {
